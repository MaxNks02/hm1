...
const projects: Project[] = [
    { id: 'comic-identifier', title: 'Comic Identifier', description: 'This is a comic identifier.' },
    { id: 'project2', title: 'Market Site', description: 'A market site to purchase items online.' },
    { id: 'project3', title: 'Zakyat Calculator', description: 'A Zakyat calculator to calculate Zakyat.' },
];
